...
from datasets import ImageNet, ImageNet2p
...
if __name__ == '__main__':
    ...
    if args.greedy_soup:
        ...
        individual_model_db = pd.read_json(INDIVIDUAL_MODEL_RESULTS_FILE, lines=True, nrows=NUM_MODELS)
